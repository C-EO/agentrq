...
| `listSkills` | List the skills this workspace can use — its own and those shared into it — with each one's description and `skill://` URI. Call it at the start of a task. |
